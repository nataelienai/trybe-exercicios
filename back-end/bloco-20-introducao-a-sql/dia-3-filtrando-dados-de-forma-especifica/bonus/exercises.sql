...
/*
4. Escreva uma query para exibir todos os cientistas (valores numéricos) cujos
projetos sejam AeH3, Ast3 ou Che1. 
*/
SELECT Scientist FROM AssignedTo WHERE Project IN ('AeH3', 'Ast3', 'Che1');

/*
5. Escreva uma query para exibir todas as informações de todos os projetos com
mais de 500 horas. 
*/
SELECT * FROM Projects WHERE Hours > 500;

/*
6. Escreva uma query para exibir todas as informações de todos os projetos
...
/*
8. Escreva uma query para exibir o nome de todos os projetos cujo código
contenha a letra 'H'.
*/
